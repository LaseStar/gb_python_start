...
class Cell:
    ...
    def __sub__(self, other):
        if self.num - other.num > 0:
            ...
            raise ValueError(f'клетка {self.num} < клетки {other.num}')
    ...
    # деление определяем тоже как целочисленное деление
